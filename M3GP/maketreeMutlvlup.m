function [tree,lastnode]=maketreeMutlvlup(level,oplist,oparity,exactlevel,depthnodes,lastnode,root,dimensions)
...
% a=intrand(1,params.max_initial_dimensions); %root node arity , this must change base on search requirements 
  a=dimensions; %Randomly generating different tree root size
end
%%
